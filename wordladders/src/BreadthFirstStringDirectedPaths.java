...
/******************************************************************************
 *  Compilation:  javac BreadthFirstStringDirectedPaths.java
 *  Execution:    java BreadthFirstStringDirectedPaths digraph.txt s
 ...
 *  Runs in O(E + V) time.
 *
 *  % java BreadthFirstStringDirectedPaths tinyDG.txt 3
 *  3 to 0 (2):  3->2->0
 *  3 to 1 (3):  3->2->0->1
 *  3 to 2 (1):  3->2
 *  3 to 3 (0):  3
...
public class BreadthFirstStringDirectedPaths {
     ...
     */
    public BreadthFirstStringDirectedPaths(StringDigraph G, int s) {
     ...
     */
    public BreadthFirstStringDirectedPaths(StringDigraph G, Iterable<Integer> sources) {
        marked = new boolean[G.V()];
        distTo = new int[G.V()];
        edgeTo = new int[G.V()];
        for (int v = 0; v < G.V(); v++)
    ...
    private void bfs(StringDigraph G, int s) {
    ...
    private void bfs(StringDigraph G, Iterable<Integer> sources) {
        Queue<Integer> q = new Queue<Integer>();
        for (int s : sources) {
            marked[s] = true;
            distTo[s] = 0;
    ...
    /**
     * Unit tests the {@code BreadthFirstStringDirectedPaths} data type.
     *
    ...
    public static void main(String[] args) {
        ...
        In in_queries = new In(args[1]);
        String[] from_to;
        while (in_queries.hasNextLine()){
            from_to = in_queries.readLine().split(" ");
            String s = from_to[0];
            String v = from_to[1];
